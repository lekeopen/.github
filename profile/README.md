...
- [**乐可点名**](https://lekeopen.com/products/leke-picker/)：本地优先的课堂随机点名工具；[公开源码](https://github.com/lekeopen/leke-picker)，Apache-2.0。
- [**归个类**](https://lekeopen.com/products/guigelei/)：本地文件智能整理工具；[官方版本发布与下载](https://github.com/lekeopen/guigelei-releases)，不代表完整源码开放。
- [**小乐 AI**](https://docs.xiaole.app)：具备记忆与行动能力的个人 AI 助手；提供公开文档，不宣称完整源码开放。
- [**乐教库**](https://lejiaoku.com)：面向 K12 教育场景的教学资源平台。

## 🛠️ 精选开源与工程

- [**leke-picker**](https://github.com/lekeopen/leke-picker)：产品型开源项目，提供本地优先的课堂随机点名工具。
- [**codex-skills**](https://github.com/lekeopen/codex-skills)：可复用 Codex 技能集合。
- [**lekee-official-site**](https://github.com/lekeopen/lekee-official-site)：采用 React、Vite、静态渲染、性能门禁和技术 SEO 的生产官网工程。
- [**uvindex240370sensor**](https://github.com/lekeopen/uvindex240370sensor)：面向行空板、PinPong 和 I2C 的硬件扩展。
